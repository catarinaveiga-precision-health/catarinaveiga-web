...
const translations: Record<string, Record<Language, string>> = {
  ...
  // Marquee
  "marquee.0": { pt: "Medicina Funcional Integrativa", en: "Integrative Functional Medicine" },
  ...
  "team.catarina.role": { pt: "Medicina Funcional Integrativa · Saúde Hormonal Feminina", en: "Integrative Functional Medicine · Women's Hormonal Health" },
  ...
  "about.role": { pt: "Especialista em Medicina Funcional Integrativa \u00b7 Sa\u00fade Hormonal Feminina", en: "Specialist in Integrative Functional Medicine \u00b7 Women\u2019s Hormonal Health" },
  "about.p1": { pt: "Acompanho mulheres em perimenopausa com sintomas reais e exames maioritariamente normais. Vinte anos de pr\u00e1tica cl\u00ednica em sa\u00fade feminina. C\u00e9dula provis\u00f3ria da ACSS ao abrigo da Lei n.\u00ba 71/2013, em valida\u00e7\u00e3o de cr\u00e9ditos.", en: "I work with women in perimenopause with real symptoms and largely normal lab results. Twenty years of clinical practice in women\u2019s health. Provisional ACSS license under Law 71/2013." },
  ...
  "about.p4": { pt: "O acompanhamento é complementar ao acompanhamento médico e não substitui diagnóstico nem prescrição. Trabalho em telemedicina, em Portugal e no estrangeiro.", en: "The follow-up is complementary to medical care and does not replace diagnosis or prescription. I work in telemedicine, in Portugal and abroad." },
  ...
  "faq.4.q": { pt: "A medicina funcional integrativa substitui o m\u00e9dico convencional?", en: "Does integrative functional medicine replace conventional doctors?" },
  "faq.4.a": { pt: "N\u00e3o. \u00c9 complementar. Quando \u00e9 necess\u00e1ria avalia\u00e7\u00e3o convencional, medica\u00e7\u00e3o ou diagn\u00f3stico, \u00e9 recomendada consulta m\u00e9dica ou referencia\u00e7\u00e3o para a especialidade indicada.", en: "No. It\u2019s complementary. When conventional assessment, medication, or diagnosis is needed, a medical consultation or referral to the appropriate specialty is recommended." },
  ...
  "terms.p2": { pt: "Os serviços de acompanhamento em Medicina Tradicional Chinesa são prestados em telemedicina, mediante agendamento prévio. A relação profissional-cliente é estabelecida formalmente na primeira consulta. Os atos médicos (prescrição, análises, diagnóstico) não fazem parte do acompanhamento e são da competência de médico. Os valores e condições dos serviços são comunicados antes do início do acompanhamento.", en: "Traditional Chinese Medicine follow-up services are provided via telemedicine, by prior appointment. The professional-client relationship is formally established at the first consultation. Medical acts (prescriptions, tests, diagnosis) are not part of the follow-up and fall within the competence of a physician. Service fees and conditions are communicated before the start of follow-up." },
